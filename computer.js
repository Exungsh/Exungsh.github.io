...
(function(window, document, parseInt) {
    ...
    var diceStart = [
        null, { x: 90, y: 0, z: 0 } // rotateX,rotateY,rotate
        , { x: 0, y: 0, z: 0 }, { x: 0, y: 90, z: 0 }, { x: 0, y: 180, z: 0 }, { x: 0, y: -90, z: 0 }, { x: -90, y: 0, z: 180 }
    ]

    // 6个结果对应的，需要将wrapper rotate的角度
    var diceResult = [
        null, { x: 270, y: 0, z: 0 } // roll出1
        , { x: 0, y: 0, z: 0 } // roll出2 // 初始状态下，2面向用户
        , { x: 0, y: 270, z: 0 } // roll出3
        , { x: 180, y: 0, z: 180 }, { x: 0, y: 90, z: 0 }, { x: 90, y: 0, z: 180 }
    ]
